...
% calculate theta for various sizes of training sets
% then calculate training set error with this theta
% and also calculate cross validation error with this theta
% and compare
for i=1:m
